...
public final class WebPubSubAsyncClient {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> removeConnectionsFromGroupsWithResponse(String hub, BinaryData groupsToRemove,
        RequestOptions requestOptions) {
        return this.serviceClient.removeConnectionsFromGroupsWithResponseAsync(hub, groupsToRemove, requestOptions);
    }
